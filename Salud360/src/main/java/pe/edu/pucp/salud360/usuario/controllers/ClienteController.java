...
public class ClienteController {
    ...
    public ResponseEntity<List<ReservaDTO>> listarReservas(@PathVariable("idCliente") Integer idCliente) {
        List<ReservaDTO> lista = clienteService.listarReservas(idCliente);
